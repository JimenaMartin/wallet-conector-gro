...
export function ConnectWalletStatus({ status, onRetry }: ConnectWalletStatusProps): React.ReactElement {
          ...
          <Box display="flex" justify="center">
            <Box maxWidth="242px">
              <Text align="center" margin="0 0 4px 0">
                Accept in your wallet. A connection request has been sent to
                your wallet
              </Text>
            </Box>
          </Box>
